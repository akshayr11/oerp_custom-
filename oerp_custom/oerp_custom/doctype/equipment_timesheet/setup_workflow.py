...
"""Equipment Timesheet approval workflow — source of truth for its design.
...
`bench export-fixtures`.
    ...
    bench --site <site> execute oerp_custom.oerp_custom.doctype.equipment_timesheet.setup_workflow.run
...
def run():
	create_workflow()
	frappe.db.commit()
	print("Equipment Timesheet workflow ready.")
